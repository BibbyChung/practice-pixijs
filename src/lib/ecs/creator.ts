...
export const getRootContainerEntity = () => {
  ...
  const componentKV = getComponentKV({
    ...
    placementComponent: new PlacementComponent(entity, EnumContainerLabel.none, 0),
  })
  return {
...
export const getSpriteEntity = (
  ...
  const componentKV = getComponentKV({
    createComponent: new CreateComponent(entity),
    placementComponent: new PlacementComponent(entity, EnumContainerLabel.root, 10),
...
export const getTextEntity = () => {
  ...
  const componentKV = getComponentKV({
    createComponent: new CreateComponent(entity),
    placementComponent: new PlacementComponent(entity, EnumContainerLabel.root, 20),
...
export const getFullScreenEntity = () => {
  ...
  const componentKV = getComponentKV({
    createComponent: new CreateComponent(entity),
    placementComponent: new PlacementComponent(entity, EnumContainerLabel.none, 100),
  })
